...
public class PhotoRecylerAdapter extends RecyclerView.Adapter<PhotoRecylerAdapter.PhotoHolder> {
    ...
    public PhotoRecylerAdapter(Context context,DataBaseHelper dbHelper,RecyclerView recyclerView){
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(itemListener != null && checkBoxStatusMap != null){
                    ...
                    itemListener.onRecyclerItemClick(number,total);
                }
...
* */
    ...
    public interface OnRecyclerItemClickListener{
        void onRecyclerItemClick(int count,int total);
    }
...
* */
     ...
     *
     */
    public void updateSyncStatusMap(){
        if(syncStatusMap == null || listData == null ){
             return;
        }
        syncStatusMap.clear();
        for(ImageInfo info : listData){
